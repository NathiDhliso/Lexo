-- Fix practice health metrics function to use correct column name 'date' instead of 'date_worked'
...
BEGIN
  ...
  IF current_user_id IS NULL THEN
    RETURN QUERY SELECT 
      75::INTEGER, 'stable'::TEXT, 0::INTEGER, 0::INTEGER, 0::INTEGER, 0::INTEGER, 
      0::INTEGER, 0::DECIMAL(10,2), 0::INTEGER, 0::DECIMAL(15,2), 0::INTEGER, 
      80::INTEGER, 10::INTEGER;
    RETURN;
  END IF;
...
COMMENT ON FUNCTION get_practice_health_metrics IS 'Provides comprehensive practice health metrics for dashboard display using correct column names';