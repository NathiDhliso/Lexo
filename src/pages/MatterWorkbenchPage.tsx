...
const MatterWorkbenchPage: React.FC<MatterWorkbenchPageProps> = ({ onNavigate }) => {
  ...
  const applyExtractedData = () => {
    ...
    if (extractedData.clientName) updates.client_name = extractedData.clientName;
    if (extractedData.clientEmail) updates.client_email = extractedData.clientEmail;
    if (extractedData.clientPhone) updates.client_phone = extractedData.clientPhone;
    if (extractedData.clientAddress) updates.client_address = extractedData.clientAddress;
    if (extractedData.caseNumber) updates.court_case_number = extractedData.caseNumber;
    if (extractedData.description) updates.description = extractedData.description;
    if (extractedData.attorneyName) updates.instructing_attorney = extractedData.attorneyName;
    if (extractedData.attorneyEmail) updates.instructing_attorney_email = extractedData.attorneyEmail;
    if (extractedData.attorneyPhone) updates.instructing_attorney_phone = extractedData.attorneyPhone;
    if (extractedData.firmName) updates.instructing_attorney_firm = extractedData.firmName;
  ...
  const handleSubmit = async () => {
    ...
    try {
      const newMatter = await matterApiService.createMatter(formData);
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-2">Upload Legal Documents</h3>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    {extractedData.clientName && (
                      <div>
                        <span className="font-medium text-green-800">Client:</span>
                        <span className="ml-2 text-green-700">{extractedData.clientName}</span>
                      </div>
                    )}
                    {extractedData.clientEmail && (
                      <div>
                        <span className="font-medium text-green-800">Email:</span>
                        <span className="ml-2 text-green-700">{extractedData.clientEmail}</span>
                      </div>
                    )}
                    {extractedData.clientPhone && (
                      <div>
                        <span className="font-medium text-green-800">Phone:</span>
                        <span className="ml-2 text-green-700">{extractedData.clientPhone}</span>
                      </div>
                    )}
                    {extractedData.caseNumber && (
                      <div>
                        <span className="font-medium text-green-800">Case Number:</span>
                        <span className="ml-2 text-green-700">{extractedData.caseNumber}</span>
                      </div>
                    )}
                    {extractedData.attorneyName && (
                      <div>
                        <span className="font-medium text-green-800">Attorney:</span>
                        <span className="ml-2 text-green-700">{extractedData.attorneyName}</span>
                      </div>
                    )}
                    {extractedData.firmName && (
                      <div>
                        <span className="font-medium text-green-800">Firm:</span>
                        <span className="ml-2 text-green-700">{extractedData.firmName}</span>
                      </div>
                    )}
                  </div>
        ...
        return (
          <div className="space-y-6 max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-2">Basic Information</h3>
              <p className="text-neutral-600">Provide the fundamental details about this matter</p>
            </div>
        ...
        return (
          <div className="space-y-6 max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-2">Client Details</h3>
              <p className="text-neutral-600">Information about the client for this matter</p>
            </div>
        ...
        return (
          <div className="space-y-6 max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-2">Attorney Information</h3>
              <p className="text-neutral-600">Details about the instructing attorney and firm</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <Building2 className="absolute left-3 top-1/2 transform -translate-y-1/2 text-neutral-400 w-4 h-4" />
                  <Input
        ...
        return (
          <div className="space-y-6 max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-2">Financial Terms</h3>
              <p className="text-neutral-600">Fee structure and financial arrangements</p>
            </div>
        ...
        return (
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-2">Review & Submit</h3>
              <p className="text-neutral-600">Review all information before creating the matter</p>
            </div>
                ...
                <CardContent>
                  <dl className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <dd className="font-medium text-right">{formData.title}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Type:</dt>
                      <dd className="font-medium text-right">{formData.matter_type}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Case Number:</dt>
                      <dd className="font-medium text-right">{formData.court_case_number || 'N/A'}</dd>
                    </div>
                  </dl>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <dl className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <dd className="font-medium text-right">{formData.client_name}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Type:</dt>
                      <dd className="font-medium text-right">{formData.client_type}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Email:</dt>
                      <dd className="font-medium text-right">{formData.client_email}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Phone:</dt>
                      <dd className="font-medium text-right">{formData.client_phone || 'N/A'}</dd>
                    </div>
                  </dl>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <dl className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <dd className="font-medium text-right">{formData.instructing_attorney}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Firm:</dt>
                      <dd className="font-medium text-right">{formData.instructing_attorney_firm}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Email:</dt>
                      <dd className="font-medium text-right">{formData.instructing_attorney_email}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Phone:</dt>
                      <dd className="font-medium text-right">{formData.instructing_attorney_phone || 'N/A'}</dd>
                    </div>
                  </dl>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <dl className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <dd className="font-medium text-right">{formData.fee_type}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Estimated Fee:</dt>
                      <dd className="font-medium text-right">R {formData.estimated_fee.toLocaleString()}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Fee Cap:</dt>
                      <dd className="font-medium text-right">R {formData.fee_cap.toLocaleString()}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-neutral-600">Risk Level:</dt>
                      <dd className="font-medium text-right">{formData.risk_level}</dd>
                    </div>
                  </dl>
                </CardContent>
              </Card>
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">Create a new legal matter</p>
              </div>
            </div>
                ...
                <div key={step.id} className="flex items-center">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3 hidden sm:block">
                      <p className={`text-sm font-medium ${isActive ? 'text-blue-600' : isCompleted ? 'text-green-600' : 'text-neutral-500'}`}>
                        {step.title}
                      </p>
