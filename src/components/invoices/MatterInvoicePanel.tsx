      ...
      {proFormaId && (
        <div className="bg-neutral-50 dark:bg-neutral-900/20 border border-neutral-200 dark:border-neutral-800 rounded-lg p-4">
          <div className="flex items-start gap-3">
            <FileText className="w-5 h-5 text-neutral-600 dark:text-neutral-400 mt-0.5" />
            ...
            <button className="px-3 py-1 bg-neutral-600 text-white rounded-lg hover:bg-neutral-700 transition-colors text-sm">
              Convert to Invoice
            </button>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-metallic-gray-900 p-4 rounded-lg border border-neutral-200 dark:border-metallic-gray-700">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-status-success-100 dark:bg-status-success-900/30 rounded-lg">
              <TrendingUp className="w-5 h-5 text-status-success-600 dark:text-status-success-400" />
            </div>
            <div>
