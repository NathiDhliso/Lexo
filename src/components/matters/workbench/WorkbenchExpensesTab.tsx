    ...
    <div className="space-y-4">
      ...
      {unbilledTotal > 0 && (
        <div className="bg-status-warning-50 border border-status-warning-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-status-warning-800 font-medium">Unbilled Disbursements</p>
              <p className="text-xs text-status-warning-600 mt-1">
                Ready to be included in the next invoice
              </p>
            </div>
            <div className="text-right">
              <p className="text-2xl font-bold text-status-warning-900">
