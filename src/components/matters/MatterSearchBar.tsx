      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg
                   ...
                   focus:ring-offset-2 focus:ring-neutral-500 transition-colors"
          disabled={isLoading}
        >
        ...
        <div className="text-sm text-gray-600">
          {isLoading ? (
            <span className="flex items-center">
              <svg className="animate-spin h-4 w-4 mr-2 text-neutral-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
