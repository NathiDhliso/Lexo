                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button
                      ...
                      className="p-3 border-2 border-neutral-300 dark:border-metallic-gray-600 rounded-lg hover:border-neutral-500 dark:hover:border-mpondo-gold-500 transition-colors text-left"
                    >
